...
class EtapaController {
  async listar(request, reply) {
    try {
      const dados = await etapaService.listarTodos();
  ...
  async buscar(request, reply) {
    try {
      const dado = await etapaService.buscarPorId(request.params.id);
  ...
  async criar(request, reply) {
    try {
      const novo = await etapaService.criar(request.body);
  ...
  async atualizar(request, reply) {
    try {
      const atualizado = await etapaService.atualizar(request.params.id, request.body);
  ...
  async deletar(request, reply) {
    try {
      await etapaService.deletar(request.params.id);
